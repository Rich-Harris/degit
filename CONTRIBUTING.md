...
Markdown and JSON touched by your change are formatted with Prettier on commit via lint-staged; run `bun run lint` locally if you want to catch issues early.
